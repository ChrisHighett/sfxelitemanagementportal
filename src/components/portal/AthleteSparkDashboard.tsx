...
const sparkCss = `
.spark-app{
  --ink:#080C13; --ink-2:#0E141F; --card:#131B27; --card-2:#172230; --line:#243245;
...
.spark-app .app{width:100%;max-width:412px;background:var(--ink);border-radius:30px;overflow:hidden;box-shadow:0 30px 80px rgba(0,0,0,.6);position:relative}
.spark-app .bar{display:flex;align-items:center;justify-content:space-between;padding:18px 20px 10px}
.spark-app .bar .crest{display:flex;align-items:center;gap:8px}
.spark-app .bar .crest .w{font-family:var(--display);font-weight:500;font-size:16px;color:#fff}
.spark-app .bar .ico{width:34px;height:34px;border-radius:50%;background:var(--card);border:1px solid var(--line);display:flex;align-items:center;justify-content:center;color:var(--soft)}

.spark-app .hero{position:relative;margin:6px 14px 0;border-radius:24px;overflow:hidden;
  background:radial-gradient(130% 100% at 80% 0%, #233247 0%, #131C29 46%, #0C121B 100%);
  border:1px solid var(--line);padding:22px 22px 20px}
.spark-app .hero::before{content:"";position:absolute;right:-50px;top:-50px;width:230px;height:230px;border-radius:50%;background:radial-gradient(circle,rgba(201,163,91,.28),transparent 62%);filter:blur(2px)}
.spark-app .hero .status{position:relative;display:inline-flex;align-items:center;gap:7px;background:rgba(55,224,137,.12);border:1px solid rgba(55,224,137,.3);color:var(--spark);font-size:11px;font-weight:600;letter-spacing:.4px;padding:5px 11px;border-radius:99px;margin-bottom:60px}
...
.spark-app .hero .pos{position:relative;font-family:var(--mono);font-size:11px;letter-spacing:2px;color:var(--gold-lite);text-transform:uppercase;margin-bottom:4px}
.spark-app .hero h1{position:relative;font-weight:800;font-size:40px;line-height:.96;letter-spacing:-1.5px;color:#fff;margin-bottom:10px}
...
.spark-app .weekrow{position:relative;display:flex;gap:8px;margin-top:18px}
.spark-app .wk{flex:1;background:rgba(255,255,255,.04);border:1px solid var(--line);border-radius:12px;padding:10px 11px}
.spark-app .wk .n{font-weight:700;font-size:18px;color:#fff;display:flex;align-items:baseline;gap:3px}
.spark-app .wk .n small{font-size:11px;color:var(--spark);font-weight:600}
.spark-app .wk .l{font-size:10px;color:var(--hint);margin-top:1px;letter-spacing:.3px}

.spark-app .sh{display:flex;align-items:center;justify-content:space-between;padding:24px 20px 12px}
...
.spark-app .reel{display:flex;gap:11px;overflow-x:auto;padding:0 20px 4px;scrollbar-width:none}
.spark-app .reel::-webkit-scrollbar{display:none}
.spark-app .clip{flex:0 0 150px;height:200px;border-radius:16px;position:relative;overflow:hidden;border:1px solid var(--line);
...
.spark-app .rings{display:flex;gap:11px;padding:0 20px}
...
.spark-app .belief{margin:0 14px;background:linear-gradient(135deg,#1d273a,#141b27);border:1px solid var(--line);border-radius:20px;padding:20px;position:relative;overflow:hidden}
...
.spark-app .milestone{margin:14px;background:var(--card);border:1px solid var(--line);border-radius:18px;padding:18px 20px}
